...
- **БД**: продуманная Prisma-схема с 11 моделями (User с RBAC/OAuth/верификацией email, Booking, Favorite, PriceAlert и 5 моделей партнёрской программы: Affiliate, Referral, Commission, Payout, AffiliateClick).
