...
│   │   │   └── extracted_code*.js{,on} # ⚠ 13 файлов-артефактов извлечения кода (мусор в src/)
│   │   ├── prisma/schema.prisma  # 11 моделей: User, Booking, Favorite, PriceAlert,
│   │   │                         #   Affiliate, Referral, Commission, Payout,
│   │   │                         #   AffiliateClick, RefreshToken, PasswordResetToken
...
| `travelhub-ultimate/backend/prisma/schema.prisma` | Схема БД: 11 моделей, enum-статусы, индексы, каскадные удаления; 5 моделей — партнёрская программа |
