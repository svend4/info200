...
Репозиторий компактный: **14 файлов, ~5 700 строк**, из них один-единственный файл кода (`src/index.ts`, 821 строка), один большой shell-скрипт установки и семь объёмных markdown-документов (~4 200 строк документации). По статистике GitHub: TypeScript 58,9 %, Shell 41,1 %.
