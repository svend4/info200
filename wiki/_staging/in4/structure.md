...
| `tesla-zluda-vps-prima-cpp-ru.html` | гайд по бюджетным GPU | 3 сценария: б/у Tesla (P40 и т.п.), ZLUDA/не-NVIDIA (AMD, Intel Arc, Mali), аренда VPS; единственный файл с заметным числом внешних ссылок (8) |
...
- **Перекрёстная навигация частичная**: calculator (10 ссылок) и favorites (7 ссылок) ссылаются на другие части, clustering-part2/3 — на предыдущие; но единого меню/индекса нет, «домой» с большинства страниц не уйти.
- **Внешние источники почти не линкованы**: `href="http…"` есть только в 3 файлах (vulkan-гайды: 2 и 1 ссылка, tesla-zluda: 8); остальные упоминания источников — просто текст.
