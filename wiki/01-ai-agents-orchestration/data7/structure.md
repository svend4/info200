...
├── dissertation_tsp_theory.md      # ~41 КБ теории: граф, когнитивная дистанция, теоремы
...
├── mmo_rpg_gamedesign_theory.md    # ~32 КБ теории геймдизайна на TSP
...
│   │   ├── api/                    # 15 файлов = 14 роутеров + __init__.py: agents, tasks,
│   │   │                           #   connections, graphs, optimization, analytics, alerts,
│   │   │                           #   reports, websocket, auth, tsp, multi_agent, knowledge,
│   │   │                           #   professional_simulator
